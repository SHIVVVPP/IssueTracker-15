...
class IssueDetailViewModel: IssueDetailViewModelProtocol {
    ...
    var title: String = ""
    var author = UserViewModel()
    var didFetch: (() -> Void)?
    var isOpened: Bool = false
    var description: String?
    var milestone: MilestoneItemViewModel?
    var comments = [CommentViewModel]()
    var labels = [LabelItemViewModel]()
    var assignees = [UserViewModel]()
    ...
    func addComment(content: String) {
        issueProvider?.addComment(issueNumber: issueNumber, content: content) { [weak self] comment in
